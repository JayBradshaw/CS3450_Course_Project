					...
					public void actionPerformed(ActionEvent e) {
						...
						if (orderHelperList.size() == 0){
							...
							if (cashSelected){
								...
								long cardNumber =  Long.parseLong(JOptionPane.showInputDialog("Enter your card number"));
								String expirationDate = JOptionPane.showInputDialog("Enter the expiration date(mm/yy)");
